        ...
        local embed = {
              {
                ...
                ["description"] = '**Nombre y apellido:** '..input[1]..'\n **EDAD:** '..input[2]..'\n **Fecha de nacimiento:** '..date..'\n **Numero de telefono:** '..input[4]..'\n **Género:** '..input[5]..'\n **Tienes experiencia en este trabajo?:** '..input[6]..'\n **¿Por qué quieres convertirte en policía?:** '..input[7]..'\n\n **Discord: **'..input[8],
              }
          }
